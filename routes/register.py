            ...
            if not is_user_existing:
                try:
                    with sql.connect('library.db') as connection:
                        ...
                        cursor.execute('INSERT INTO register_and_login(Username, password, email, role) VALUES(?,?,?,?)', 
                ...
                return render_template('login.html', error_message="Email already registered. Please login")
